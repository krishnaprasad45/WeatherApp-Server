    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, weatherDataModel_1.default.findOne({ email: email })];
                case 1:
                    userData = _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    user = new weatherDataModel_1.default(__assign({}, data));
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, weatherDataModel_1.default.updateOne({ email: email }, {
                            $set: {
                                otp: generatedOtp,
                ...
                case 2:
                    ...
                    setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, weatherDataModel_1.default.updateOne({ email: email }, {
                                        $unset: {
                                            otp: "",
                                            otpCreatedAt: "",
                                        },
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, weatherDataModel_1.default
